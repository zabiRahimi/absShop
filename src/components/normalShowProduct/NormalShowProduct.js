...
export default function NormalShowProduct({ title, hasMore, linkMore, bgColor, products, hasTitle = false }) {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            const getNumColumnPro = containerNSP_pro.current[0] && Math.floor(containerNSP_products.current.offsetWidth / Object.values(containerNSP_pro.current[0])[0].offsetWidth);
            ...
            if (getNumColumnPro) {
                ...
                switch (getNumColumnPro) {
                    ...
                    case 2:
                        getNumShowPro < 12 ? setGetNumShowPro(12) : setGetNumShowPro(prev => prev - (prev % 2));

                        setMoreShowPro(6);

                        break;
                    case 3:
                        getNumShowPro < 15 ? setGetNumShowPro(15) : setGetNumShowPro(prev => prev - (prev % 3));
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        getNumShowPro < 18 ? setGetNumShowPro(18) : setGetNumShowPro(prev => prev - (prev % 6));

                        setMoreShowPro(12);

                        break;
                    case 7:
                        getNumShowPro < 21 ? setGetNumShowPro(21) : setGetNumShowPro(prev => prev - (prev % 7));

                        setMoreShowPro(14);

                        break;
                    case 8:
                        getNumShowPro < 24 ? setGetNumShowPro(24) : setGetNumShowPro(prev => prev - (prev % 8));

                        setMoreShowPro(16);

                        break;
                    case 9:
                        getNumShowPro < 27 ? setGetNumShowPro(27) : setGetNumShowPro(prev => prev - (prev % 9));

                        setMoreShowPro(18);

                        break;
                    case 10:
                        getNumShowPro < 30 ? setGetNumShowPro(30) : setGetNumShowPro(prev => prev - (prev % 10));
        ...
        if (i < getNumShowPro) {
            return <div className='containerNSP_pro' ref={containerNSP_pro.current[i]} key={i}>
                <div className='divImgNSP'>
                    ...
                    <img className='imgNSP' src={require(`../../assets/images/products/${pro.img}`)} alt={pro.img} />
                ...
                <div className='containerPriceNSP'>
                    ...
                    <div className='percentNSP'>
                        {pro.oldPrice ? `${Intl.NumberFormat('fa-IR').format(Math.floor(((pro.oldPrice - pro.price) / pro.oldPrice) * 100))}%` : ''}
                    </div>
                ...
                <div className='containerOldPriceNSP'>
                    ...
                    <div className='oldPriceNSP'>
                        {pro.oldPrice ? Intl.NumberFormat('fa-IR').format(pro.oldPrice) : ''}
                    </div>
    ...
    return (
        <div className="containerNSP" ref={containerNSP}>
            ...
            {
                hasTitle && <div className='cotainerTitleNSP'>

                    <h2 className='titleNSP'>
                        {title}
                    </h2>

                    {
                        hasMore && <div className='containerShowAllNSP'>
